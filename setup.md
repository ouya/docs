...
For information on the API commands available, please consult the [Android API reference documentation](http://developer.android.com/guide/components/index.html).
