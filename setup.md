...
**Note**: The Android navigation bar will consume some of the screen on standard tablets, an OUYA does not have a navigation bar, and so it is unlikely a tablet will give you a perfect replica of a running OUYA, but it will be enough to get most of your code running. You may still need to perform UI tweaks to use the 1920x1080 display buffer made available to apps by default on an OUYA.
