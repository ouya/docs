...
* [MiBox(Enhanced)](http://dev.xiaomi.com/doc/p=3838/index.html) [[XiaomiShop]](http://www.honorbuy.com/116-original-mi-box-proenhanced-3rd-quad-core-smart-tv-4k-hd-box.html)

## Update to the latest ODK

Download latest ODK ([ODK-1.3.1501](https://ouya-sdks.s3.amazonaws.com/xiaomi/odk-xiaomi-1.3.1501.zip)) from the OUYA [Developer portal](http://devs.ouya.tv) and setup your game to use it.
...
* Update to the latest ODK ([ODK-1.3.1501](https://ouya-sdks.s3.amazonaws.com/xiaomi/odk-xiaomi-1.3.1501.zip)).
...
![down image](enable_xiaomi_support/image_11.png)

Enter the `OUYA` Category.

![OUYA Category](enable_xiaomi_support/image_12.png)

Play `OUYA` Games!

![OUYA Games](enable_xiaomi_support/image_13.png)
